...
class WorkoutList : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.let { layout ->
            ...
            joggingEntriesAdapter = JoggingEntriesAdapter(listOfJoggingEntries, object :
            ...
            freeWeightEntriesAdapter = FreeWeightEntriesAdapter(listOfFreeWeightEntries, object :
                AdapterClickListener {
                override fun click(id: Int) {
